...
export default function TaskBoard({ projectId, canEdit }) {
  ...
  if (tasks.length === 0) {
    return (
      <EmptyState
        icon={Clock}
        title="Nessun task"
        description="Crea il primo task per iniziare a organizzare il lavoro."
    ...
    <>
      ...
      {canEdit && (
        <Button
          ...
          className="mt-4 bg-[#ef6144] hover:bg-[#d9553a]"
        >
