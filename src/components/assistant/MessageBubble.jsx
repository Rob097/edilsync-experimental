...
export default function MessageBubble({ message }) {
  ...
  return (
    <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
      {!isUser && (
        <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#ef6144] to-orange-600 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
        {message.content && (
          <div className={cn(
            ...
            isUser ? "bg-[#ef6144] text-white" : "bg-white border border-gray-200"
          )}>
            {isUser ? (
