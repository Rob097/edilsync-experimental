export const getFinanceSectionTour = (language = 'it', permissionScope = 'manager') => {
    ...
    return {
      ...
      steps: filterSteps([
        ...
        },
        {
          ...
          content: 'Questa sezione ti aiuta a controllare budget, consuntivi e SAL del progetto in un unico punto.',
          placement: 'top',
        },
        {
        ...
        },
        {
          ...
          content: 'Qui imposti il preventivo analitico del progetto: categoria, importi e società responsabile.',
          placement: 'top',
        },
        {
  ...
  return {
    ...
    steps: filterSteps([
      {
        target: null,
        title: 'Welcome to project finance',
      ...
      },
      {
        target: '[data-tour="finance-budget-card"]',
        title: 'Budget lines',
        content: 'Set the project estimate by categories, amounts, and responsible company.',
        placement: 'top',
      },
      {
        target: '[data-tour="finance-costs-card"]',
    ...
    const map = {
      kpi: {
        ...
        steps: [
          ...
          { target: '[data-tour="finance-kpi-budget"]', title: 'Budget pianificato', content: 'Somma delle voci preventivate: è il valore target del progetto.', placement: 'bottom' },
      ...
      settings: {
        ...
        steps: [
          { target: null, title: 'Guida Impostazioni economiche', content: 'Questa card definisce le regole con cui il progetto interpreta i dati economici.', placement: 'center' },
          ...
          { target: '[data-tour="finance-settings-visibility"]', title: 'Visibilità', content: 'Decidi se i dati economici sono visibili all’intero progetto o per società.', placement: 'bottom' },
          ...
          { target: '[data-tour="finance-settings-sal-toggle"]', title: 'Abilitazione SAL', content: 'Attiva o disattiva la gestione SAL nel progetto.', placement: 'bottom' },
      ...
      costs: {
        ...
        steps: [
          { target: null, title: 'Guida Consuntivi', content: 'Qui registri i costi reali che stanno maturando nel progetto.', placement: 'center' },
  ...
  const map = {
    kpi: {
      ...
      steps: [
        ...
        { target: '[data-tour="finance-kpi-row"]', title: 'Card purpose', content: 'These KPIs provide a quick health check of project economics.', placement: 'bottom' },
    ...
    settings: {
      id: 'finance_card_help_settings',
      steps: [
        { target: null, title: 'Financial settings guide', content: 'This card defines how project finance is interpreted.', placement: 'center' },
        ...
        { target: '[data-tour="finance-settings-visibility"]', title: 'Visibility', content: 'Define whether finance data is whole-project or company-scoped.', placement: 'bottom' },
    ...
    budget: {
      id: 'finance_card_help_budget',
      steps: [
        { target: null, title: 'Budget lines guide', content: 'This card manages your project estimate.', placement: 'center' },
