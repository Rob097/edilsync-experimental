...
const pageMap = {
  funzionalita: {
    it: {
      ...
      subtitle: 'Ogni modulo e pensato per ridurre caos operativo e prevenire dispute prima che diventino costo.',
      challenges: [
        ...
        'Difficolta nel capire chi e responsabile di blocchi e ritardi.',
      ],
      modules: [
        { title: 'Task + Milestone', text: 'Board e timeline collegate, assegnazioni per persona o societa e stato blocked con causa documentata.' },
      ...
      workflow: ['Imposti progetto e partecipanti contestuali.', 'Coordini lavoro e documentazione in tempo reale.', 'Gestisci extra e approvazioni in modo tracciabile.', 'Se emerge conflitto, hai gia timeline ed evidenze.'],
      outcomes: ['Meno rilavorazioni da incomprensione.', 'Meno esposizione legale su scope e ritardi.', 'Piu fiducia tra impresa, committente e tecnici.'],
      faq: [
        { q: 'EdilSync sostituisce WhatsApp?', a: 'Per il progetto si: conversazioni, documenti e decisioni restano nel contesto giusto.' },
        { q: 'Posso usarlo anche da mobile?', a: 'Si, con superfici operative pensate per uso in cantiere.' },
      ],
  ...
  'per-imprese': {
    it: {
      eyebrow: 'Per imprese',
      title: 'Proteggi margine e reputazione, mentre coordini il cantiere in modo piu veloce.',
      subtitle: 'EdilSync nasce per il dolore reale delle imprese: dispute su extra, blocchi non tracciati, responsabilita ambigue.',
      challenges: [
      ...
      modules: [
        ...
        { title: 'Task blocked con responsabilita', text: 'Documenti blocchi e cause per evitare colpe improprie.' },
      ...
      workflow: ['Avvii progetto da contesto aziendale.', 'Inviti committente e partner con ruoli coerenti.', 'Gestisci operativita quotidiana con tracciamento nativo.', 'Difendi decisioni e margine quando nasce contestazione.'],
      outcomes: ['Riduzione attriti su scope e pagamenti.', 'Maggiore controllo sui tempi reali di esecuzione.', 'Percezione professionale piu forte verso il cliente.'],
      faq: [
        { q: 'Quanto tempo serve per partire?', a: 'L onboarding e guidato e pensato per adozione rapida, anche per team poco digitalizzati.' },
        { q: 'Posso coinvolgere il committente senza complicare il flusso?', a: 'Si, con accessi contestuali e visibilita calibrata.' },
      ],
  ...
  'per-committenti': {
    it: {
      ...
      challenges: ['Aggiornamenti sporadici e poco affidabili.', 'Difficolta nel capire perche il progetto rallenta.', 'Extra economici discussi in modo ambiguo.'],
      modules: [
      ...
      workflow: ['Ricevi invito al progetto.', 'Segui stato e prossime attivita.', 'Approvi o chiarisci varianti.', 'Collabori con impresa e tecnici su dati condivisi.'],
      outcomes: ['Meno stress e meno sorprese finali.', 'Piu chiarezza su costi e tempi.', 'Maggiore fiducia nel team che esegue i lavori.'],
      faq: [{ q: 'Serve esperienza tecnica?', a: 'No. La lettura del progetto e orientata a chiarezza e decisioni pratiche.' }],
  ...
  'per-subappaltatori': {
    it: {
      ...
      challenges: ['Informazioni arrivate tardi.', 'Sopralluoghi senza condizioni pronte.', 'Poca visibilita su dipendenze tra squadre.'],
      modules: [
      ...
      workflow: ['Ricevi invito del contractor.', 'Accedi alle attivita rilevanti.', 'Condividi avanzamenti e blocchi.', 'Chiudi il lavoro con prove e storico.'],
      outcomes: ['Meno viaggi a vuoto.', 'Migliore puntualita operativa.', 'Riduzione errori da coordinamento.'],
      faq: [{ q: 'Vedo solo cio che mi serve?', a: 'Si, il perimetro e contestuale al ruolo e alla partecipazione attiva.' }],
  ...
  'per-tecnici': {
    it: {
      eyebrow: 'Per tecnici',
      title: 'Dalla revisione tecnica alla realta di cantiere, senza disconnessioni.',
      subtitle: 'Architetti, ingegneri e consulenti collaborano su documenti, varianti e stato lavori nello stesso sistema.',
      challenges: ['Revisioni tecniche non allineate con esecuzione.', 'Commenti e file dispersi in piu strumenti.', 'Decisioni senza trail verificabile.'],
      modules: [
        ...
        { title: 'Collaborazione multi-attore', text: 'Impresa, committente e tecnici lavorano su un unico stato di verita.' },
      ],
      ...
      outcomes: ['Maggiore coerenza tra progetto e realizzazione.', 'Meno errori da documenti non aggiornati.', 'Piu chiarezza su responsabilita tecniche.'],
      faq: [{ q: 'Posso usare EdilSync anche solo per parte documentale?', a: 'Si, ma il valore cresce quando documenti e operativita restano collegati.' }],
  ...
  'come-funziona': {
    it: {
      ...
      challenges: ['Kickoff disordinato e ruoli non chiari.', 'Operativita scollegata da richieste e documenti.', 'Conflitti gestiti quando e troppo tardi.'],
      modules: [
        ...
        { title: '4. Chiusura dispute', text: 'Se serve, apri caso con eventi ed evidenze gia raccolte.' },
      ],
      workflow: ['Kickoff', 'Coordinamento', 'Formalizzazione extra', 'Difesa operativa'],
      outcomes: ['Ciclo decisionale piu veloce.', 'Meno attrito tra soggetti coinvolti.', 'Meno rischio di contenzioso aperto.'],
      faq: [{ q: 'E adatto anche a progetti piccoli?', a: 'Si, soprattutto dove la comunicazione pesa molto sul risultato finale.' }],
  ...
  prezzi: {
    it: {
      eyebrow: 'Prezzi',
      title: 'Prezzo semplice, adozione rapida, nessuna sorpresa.',
      subtitle: 'EdilSync mantiene un modello chiaro: l impresa paga il piano, committenti e subappaltatori collaborano gratis nello stesso progetto.',
      ...
      modules: [
        { title: 'Piano unico trasparente', text: 'Tariffa fissa mensile senza costo per utente e senza costo per progetto.' },
        { title: 'Accesso esteso ai ruoli esterni', text: 'Committenti e subappaltatori possono entrare gratis mantenendo lo stesso contesto operativo.' },
        { title: 'Partenza immediata', text: 'Setup rapido, flussi chiari e supporto operativo per attivare il team senza frizioni.' },
      ],
      ...
      outcomes: ['Costi prevedibili fin da subito.', 'Adozione piu veloce sul campo.', 'Ritorno immediato su tempo e coordinamento.'],
      faq: [{ q: 'Il prezzo e davvero fisso?', a: 'Si, il piano e fisso: nessun costo per utente e nessun costo per progetto.' }],
      primaryCta: { href: '/contatti', label: 'Parla con il team' },
      secondaryCta: { href: '/faq', label: 'Domande frequenti' },
    },
    en: {
      eyebrow: 'Pricing',
      title: 'Simple pricing, fast adoption, zero surprises.',
      subtitle: 'EdilSync keeps one clear model: the contractor pays the plan, while owners and subcontractors collaborate for free in the same project.',
      ...
      modules: [
        { title: 'Transparent single plan', text: 'Fixed monthly fee with no per-user and no per-project costs.' },
        { title: 'Extended access for external roles', text: 'Owners and subcontractors join for free while staying in the same project context.' },
        { title: 'Immediate start', text: 'Fast setup, clear workflows, and practical support to activate teams quickly.' },
      ],
      ...
      faq: [{ q: 'Is the price really fixed?', a: 'Yes, the plan is fixed: no per-user and no per-project charges.' }],
  ...
  faq: {
    it: {
      eyebrow: 'FAQ',
      title: 'Risposte rapide alle domande piu frequenti.',
      ...
      outcomes: [],
      faq: [
        { q: 'EdilSync e adatto a team piccoli?', a: 'Si, e stato pensato proprio per realta operative con tempi stretti e risorse limitate.' },
        { q: 'Serve formazione lunga?', a: 'No. L onboarding guidato punta a far partire subito i flussi critici.' },
        { q: 'Posso invitare committente e subappaltatori?', a: 'Si, con accessi contestuali e perimetro dati controllato.' },
        { q: 'Funziona da smartphone?', a: 'Si, inclusa esperienza operativa per attivita di campo.' },
      ],
  ...
  contatti: {
    it: {
      ...
      challenges: ['Cantieri gestiti su strumenti frammentati.', 'Scarsa visibilita tra attori principali.', 'Mancanza di storico utile in caso di conflitto.'],
      modules: [
        { title: 'Demo role-based', text: 'Mostriamo il flusso specifico per impresa, committente, tecnici e subappalto.' },
        { title: 'Mappa criticita', text: 'Identifichiamo i punti dove oggi perdi tempo, margine o controllo.' },
      ],
      workflow: ['Contatto', 'Call di allineamento', 'Demo personalizzata', 'Piano next-step'],
      outcomes: ['Visione chiara del fit operativo.', 'Percorso di adozione realistico.', 'Decisione piu rapida e informata.'],
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
            ...
            <p data-reveal className="mt-5 text-[16px] sm:text-[18px] leading-[1.72] text-[#d8e1eb] max-w-3xl mx-auto">
              {locale === 'en'
                ...
                : 'Prenota una demo focalizzata per vedere come EdilSync puo ridurre dispute e aumentare chiarezza operativa.'}
            </p>
