...
const pageMap = {
  ...
  prezzi: {
    it: {
      ...
      subtitle: 'EdilSync usa un modello esplicito: privati sempre free, societa free o paid, premium progetto sbloccato tramite sponsorship attiva.',
      ...
      modules: [
        { title: 'Societa free o paid', text: 'La societa puo partire free e passare a Pro quando deve sbloccare sponsorship e premium societario.' },
        { title: 'Sponsorship progetto', text: 'Il premium di progetto non dipende dal ruolo contractor: dipende dalla societa paid che sponsorizza il progetto.' },
        { title: 'Accesso gratuito su invito', text: 'Homeowner, subappaltatori e professionisti entrano gratis nei progetti invitati mantenendo lo stesso contesto operativo.' },
      ],
      ...
      faq: [{ q: 'Come si sblocca il premium di progetto?', a: 'Con una sponsorship attiva da parte di una societa paid che partecipa al progetto.' }],
