...
const contentByLocale = {
  it: {
    ...
    seoDescription:
      'Da zero a cantiere coordinato in pochi minuti: onboarding, cantiere, inviti, operatività e controllo finale in un unico flusso.',
    badge: 'Come funziona',
    ...
    steps: [
      ...
      },
      {
        ...
        note: "La società è l'unità operativa del cantiere. Puoi avere responsabili di cantiere, capicantiere, operai, backoffice: ognuno con permessi adeguati al proprio ruolo.",
        icon: Building2,
      },
      {
        number: '03',
        ...
        note: 'Il cantiere è il contenitore di tutte le relazioni: committente, contractor, subappaltatori, professionisti, documenti, task, chat e finanza.',
        icon: FolderOpen,
      },
      {
        number: '04',
        ...
        note: 'Il committente entra gratis. Subappaltatori e professionisti entrano gratis nei cantieri a cui sono invitati. Gli strumenti avanzati di cantiere si attivano quando una società paid sponsorizza il cantiere.',
        icon: Users,
      },
      {
        number: '05',
        title: 'Lavora e documenta',
        text: 'Task, foto, messaggi, varianti, scadenze: ogni azione diventa automaticamente documentazione tracciabile nel feed del cantiere.',
      ...
      },
      {
        ...
        text: 'Monitora avanzamento, costi e milestone. Gestisci varianti approvate e dispute documentate. Chiudi il cantiere con uno storico completo.',
  ...
  en: {
    ...
    seoDescription:
      'From zero to a coordinated construction site in minutes: onboarding, worksite setup, participant invites, daily execution, and final control.',
    badge: 'How it works',
    ...
    steps: [
      ...
      },
      {
        ...
        note: 'The company is the operational unit of the jobsite. You can have site managers, foremen, workers, and backoffice with contextual permissions.',
        icon: Building2,
      },
      {
        number: '03',
        title: 'Create the worksite',
        text: 'Open a new worksite in EdilSync. Add address, dates, description, and initial photo documentation.',
        note: 'The worksite is the container for all relationships: owner, contractor, subcontractors, professionals, docs, tasks, chat, and finance.',
        icon: FolderOpen,
      },
      {
        number: '04',
        ...
        note: 'The homeowner joins free. Subcontractors and professionals can join invited worksites for free. Premium worksite capabilities unlock when a paid company sponsors the worksite.',
        icon: Users,
      },
      {
        number: '05',
        title: 'Work and document',
        text: 'Tasks, photos, messages, changes, deadlines - every action automatically becomes traceable worksite documentation.',
      ...
      },
      {
        ...
        text: 'Monitor progress, costs, and milestones. Manage approved changes and documented disputes. Close with complete worksite history.',
