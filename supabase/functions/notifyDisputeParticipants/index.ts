...
const ALLOWED_ACTIONS = ["dispute_opened", "dispute_status_changed", "dispute_commented"];
...
Deno.serve(async (req) => {
  try {
    ...
    const recipients = await resolveProjectRecipients(context, { excludeActor: true });
    ...
    console.error("notifyDisputeParticipants error:", error);
